...
public class backgroundtest extends JPanel {
     ...
     */
    public backgroundtest(Image image) {
        this(image, SCALED);
    }
     ...
     */
    public backgroundtest(Image image, int style) {
        setImage(image);
        setStyle(style);
     ...
     */
    public backgroundtest(Image image, int style, float alignmentX, float alignmentY) {
        setImage(image);
        setStyle(style);
     ...
     */
    public backgroundtest(Paint painter) {
        setPaint(painter);
        setLayout(new BorderLayout());
    }
    ...
    public static void main(String[] args) {
        ...
        backgroundtest background = new backgroundtest(img, backgroundtest.SCALED, 0.50f, 0.5f);
