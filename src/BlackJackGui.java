...
public class BlackJackGui {
    ...
    public void init() throws InterruptedException {
        ...
        backgroundtest background2 = new backgroundtest(img2, backgroundtest.SCALED, 0.50f, 0.5f);
        ...
        backgroundtest background = new backgroundtest(img, backgroundtest.ACTUAL, 0.50f, 0.5f);
